...
# Load the data
prom = pd.read_excel("D:/C DRIVE-SSD DATA backup 15-12-2020/Desktop/360digitmg material/Hypothesis Testing/Promotion.xlsx")
prom
...
cof = pd.read_excel("D:/C DRIVE-SSD DATA backup 15-12-2020/Desktop/360digitmg material/Hypothesis Testing/ContractRenewal_Data(unstacked).xlsx")
cof
...
two_prop_test = pd.read_excel("D:/C DRIVE-SSD DATA backup 15-12-2020/Desktop/360digitmg material/Hypothesis Testing/JohnyTalkers.xlsx")
...
Bahaman = pd.read_excel("D:/C DRIVE-SSD DATA backup 15-12-2020/Desktop/360digitmg material/Hypothesis Testing/Bahaman.xlsx")
Bahaman
